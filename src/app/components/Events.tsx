...
export function Events() {
  const upcomingEvents = [
    ...
    // { id: 1, date: "2026-05-10", venue: "Venue Name", city: "City, ST", title: "Event Title", description: "Details" },
  ];
        ...
        <section className="mb-16">
          ...
          {upcomingEvents.length === 0 ? (
            ...
            <div className="space-y-6">
              {upcomingEvents.map((event: { id: number; date: string; venue: string; city: string; title: string; description: string }) => (
